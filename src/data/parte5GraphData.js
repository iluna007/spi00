/**
 * Grafo relacional Parte 5 (De la potencia del entendimiento). Estructura base.
 */
...
const defs = Array.from({ length: 2 }, (_, i) => ({ id: `Definicion ${i + 1}`, name: `Definición ${i + 1}`, type: 'definicion', val: 1, path: `${FOLDER.definicion}/Definicion ${i + 1}.md` }))
